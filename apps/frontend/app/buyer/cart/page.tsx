...
export default function BuyerCartPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <Reveal stagger staggerGap={0.06}>
        {cart.items.map((item) => (
          <RevealItem key={item.id}>
            <div className="mb-3 flex gap-4 rounded-xl border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
      ...
      <Reveal delay={0.1}>
        <TiltCard radiusClassName="rounded-xl" className="mt-2 ml-auto max-w-sm">
          <div className="rounded-xl border-t border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
            ...
            <Magnetic className="mt-3 block">
              <Button size="lg" className="w-full" onClick={() => router.push('/buyer/checkout')}>
                Lanjut ke Checkout
              </Button>
            </Magnetic>
          </div>
