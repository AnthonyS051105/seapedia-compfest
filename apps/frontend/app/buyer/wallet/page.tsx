  ...
  return (
    <div>
      ...
      {wallet === undefined ? (
        ...
        <Reveal>
          <TiltCard radiusClassName="rounded-2xl" className="max-w-sm">
            <div className="rounded-2xl border border-brand-200 bg-linear-to-br from-brand-50 to-white p-6 dark:border-brand-500/30 dark:from-brand-500/10 dark:to-zinc-950">
      ...
      {wallet === undefined ? (
        ...
        <Reveal stagger staggerGap={0.05}>
          {wallet.transactions.map((txn) => (
            <RevealItem key={txn.id}>
              <div className="flex gap-4 border-b border-zinc-100 py-3 last:border-0 dark:border-zinc-800">
