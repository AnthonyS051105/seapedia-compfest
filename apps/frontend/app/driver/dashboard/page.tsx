...
export default function DriverDashboardPage() {
  ...
  const [activeJob, setActiveJob] = useState<JobDetail | null | undefined>(
    undefined,
  );
  const [earnings, setEarnings] = useState<DriverEarnings | null | undefined>(
    undefined,
  );
  ...
  useEffect(() => {
    ...
    api
      .get<PaginatedResponse<unknown>>("/driver/jobs", {
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <p className="font-semibold text-zinc-950 dark:text-zinc-50">
                    Pekerjaan Aktif #
                    {activeJob.order_id.slice(0, 8).toUpperCase()}
                  </p>
                </div>
          ...
          <Card>
            <div className="flex items-center justify-between gap-4">
              <p className="text-sm text-zinc-600 dark:text-zinc-400">
                ...
                pekerjaan tersedia untuk diambil.
              </p>
              <Magnetic>
